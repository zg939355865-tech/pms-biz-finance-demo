...
console.log("--- verify ---");
console.log(parsed.mockData.availableOrderLines.map((r) => r.purchaseOrderNo + "/" + r.purchaseOrderLineNo + " " + r.itemName + " 暂估" + r.estimatedUnitPrice + " 含税" + r.taxIncludedUnitPrice + " 单位价差" + (r.taxIncludedUnitPrice - r.estimatedUnitPrice)).join("\n"));
